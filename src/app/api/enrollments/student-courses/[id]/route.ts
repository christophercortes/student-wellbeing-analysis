...
find the courses a specific student enrolled in by the student id. 
For example this would be called in a url request like this:

https://localhost3000/api/enrollments/student-courses/[id]

or

https://localhost3000/api/enrollments/student-courses/682e36436d63526097a78fa1
...
// Get the course ids from the selected student id
