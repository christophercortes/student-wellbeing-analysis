        ...
        isActive: boolean;})
{
    ...
    const [newDurationInWeeks, setNewDurationInWeeks] = useState(durationInWeeks);
    ...
    return (<>
        <h2 className="mt-8 text-lg font-semibold text-center text-gray-700">Create New Course</h2>
        <div className="flex justify-center items-center">
            <form onSubmit={ handleSubmit } className="flex flex-col gap-3 px-8 py-2 mt-9 w-3/5 justify-center">
                <div className="border border-gray-700 px-8 py-2">
                    ...
                    >Course Name:</label>
                    <input
                        onChange={ (e) => setNewCourseName(e.target.value) } // When this changes, set the value of the variable
                        value={ newCourseName } // This is equal to the state above 
                    ...
                    <input
                        onChange={ (e) => {
                                ...
                                if (Number.isNaN(e.target.valueAsNumber))
                                {
                                    ...
                                    setNewDurationInWeeks(e.target.valueAsNumber = 1);
                                } else {
                                    setNewDurationInWeeks(e.target.valueAsNumber)} 
                            }
                        } 
                        value={ newDurationInWeeks }   
                        className="border rounded px-3 py-2 w-full text-gray-700" 
                        type="number" 
                ...
                <div className="border border-gray-700 px-8 py-2">
                    ...
                    <div className="flex justify-between">
                        ...
                        <p className="text-m font-medium text-gray-700">
                            { newIsActive ? 'Active': 'Not Active' }
                        </p>
                    </div>
                </div>
                <div>
                    <button className="bg-blue-300 shrink text-gray-700 py-3 px-6 w-fit border px-8 py-2 hover:bg-blue-400 hover:text-white" type="submit">Edit Course</button>
                </div>
                <div>
